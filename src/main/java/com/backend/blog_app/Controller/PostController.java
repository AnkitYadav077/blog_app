...
import com.backend.blog_app.Service.FileService;
import com.backend.blog_app.Service.PostService;
...
public class PostController {
    ...
    public ResponseEntity<List<PostDto>> searchPostByTitle(@PathVariable("keywords") String keyworks) {

        List<PostDto> result = this.postService.searchPosts(keyworks);
