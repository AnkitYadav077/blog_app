...
import com.backend.blog_app.Repo.CategoryRepo;
...
public class PostServiceImpl implements PostService{
    ...
    @Override
    public PostDto createPost(PostDto postDto,Integer userId,Integer categoeyId) {
        User user=this.userRepo.findById(userId).orElseThrow(()->new ResourceNotFoundException("User","User id",userId));
        Category category=this.categoryRepo.findById(categoeyId).orElseThrow(()-> new ResourceNotFoundException("Category","category Id",categoeyId));
